...
//     formData.append("title", title);
//     formData.append("content", content);
//     formData.append("slug", (slug || title) + "-" + Date.now());
//     formData.append("author", author);
//     formData.append("short_description", short_description);
//     formData.append("source", source);
//     formData.append("category", category);
...
//       "https://daytodaynews-backend.onrender.com/student/upload",
//       formData,
//       {
//         headers: {
//           Authorization: `Bearer ${token}`,
...
<div className="md:pl-64 p-3">
 <div className="box  bg-red-400 
    ...
    setShortdescription("");
    setSource("");
    setThumbnail(null)}}>Add News</button></span>
...
>
  ...
  <table className="w-full max-w-7xl mx-auto border-collapse rounded-lg shadow-2xl">
    ...
    <tbody className="bg-white text-black">
      {student.filter((v)=>v.category==="Social")
      .map((v) => (
        <tr
          key={v._id}

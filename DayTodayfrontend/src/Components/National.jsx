 ...
 setDel(deleted);
  ...
  <div className="box  bg-red-400 
              ...
              <span className="justify-end flex my-2 px-2">    
  <button
    className="bg-blue-500 px-4 py-2
    cursor-pointer hover:scale-95 transition-all duration-150 rounded-lg font-semibold text-white shadow"
  ...
  >
   ...
   <table className="w-full max-w-7xl mx-auto border-collapse rounded-lg shadow-2xl">
     ...
     <tbody className="bg-white text-black">
       {student.filter((v)=>v.category==="national")
       .map((v) => (
         <tr
           key={v._id}

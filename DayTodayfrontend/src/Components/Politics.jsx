      ...
      >
       ...
       <div className="flex justify-center mt-8">
        <button
          ...
          hover:bg-indigo-700 active:scale-95 transition font-semibold"
         >
          Add Post
        </button>
      </div>
...
{modal2 && (
    ...
    <form className="w-full max-w-4xl bg-white rounded-2xl shadow-xl p-8 relative">
      ...
      <div className="flex justify-center mt-8">
        <button
          ...
          className="bg-indigo-600 text-white px-8 py-2 rounded-lg
          hover:bg-indigo-700 active:scale-95 transition font-semibold cursor-pointer"
        >
          Update Post
        </button>
      </div>
  ...
  <table className="w-full max-w-7xl mx-auto border-collapse rounded-lg shadow-2xl">
    ...
    <tbody className="bg-white text-black">
      {student.filter((v)=>v.category==="Politics")
      .map((v) => (
        <tr
          key={v._id}
